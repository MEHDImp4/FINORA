...
| iOS target: physical device (iPhone), iOS 16+ | ⬜ |
...
| 6.2 | Play movie (forced transcode) | Starts cleanly, transcoding indicator visible | ⬜ |
...
| 6.8 | Playback speed setting (e.g. 1.25x) | Applied immediately when player opens | ⬜ |
...
| # | Test | Expected | Status |
|---|------|----------|--------|
| 7.1 | Double tap left half | -10s seek, ripple indicator shown | ⬜ |
| 7.2 | Double tap right half | +10s seek, ripple indicator shown | ⬜ |
...
| 8.2 | Picture-in-Picture | PiP activates, mini player floats over home screen | ⬜ |
...
| 9.3 | Pause download | Status shows paused | ⬜ |
...
| # | Test | Expected | Status |
|---|------|----------|--------|
| 10.1 | New item added to Jellyfin library | Foreground notification fires on next sync | ⬜ |
